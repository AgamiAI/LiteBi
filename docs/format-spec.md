...
| `<artifacts_dir>/<profile>/golden_datasets/<name>.yaml` | Golden dataset: agreed questions + answer-key SQL, match strictness, required filters (filename stem is the dataset name)                              | User-authored                                                                    |
