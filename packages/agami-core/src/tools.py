...
SERVER_INSTRUCTIONS = (
    ...
    "undeclared (it matches none, or wrote no predicate to match) / undeclarable (an endpoint is a "
    "name the statement bound for itself) / undetermined (the join could not be read — NOT a claim "
    "that the model does not declare it; that gap is on the section's own `undetermined` "
    "sentence). Don't refuse on an unreviewed metric — answer and warn. ALSO read "
