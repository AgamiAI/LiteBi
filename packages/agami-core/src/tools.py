...
SERVER_INSTRUCTIONS = (
    ...
    "sibling `scope` field ('main', 'cte:<name>', 'subquery', each carrying a trailing '#<n>' arm "
    "number when that scope is one of two or more arms of a UNION / INTERSECT / EXCEPT) because a "
