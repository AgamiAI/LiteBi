...
# The runtime is importable, a model resolves, the assembler works, and the statement was not refused
# — an operator turned the semantic-model pass off (`AGAMI_GOVERNANCE_ENFORCED`, ACE-101) and the
